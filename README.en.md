...
Download the versioned HAR from [GitHub Releases](https://github.com/mobilewhj/harmonyOfflineSdk/releases) and declare a `file:../libs/harmony-offline-sdk-0.1.0.har` dependency named `harmony-offline-sdk`. OHPM registry publication is pending.
